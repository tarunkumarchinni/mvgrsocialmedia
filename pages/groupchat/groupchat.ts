...
import { NavController, NavParams, IonicPage, ActionSheetController, Content, Events, LoadingController } from 'ionic-angular';
import { Groupsprovider } from '../../providers/groupsprovider/groupsprovider';
import { Imghandler } from '../../providers/imghandler/imghandler';
import { Groupbuddies } from '../groupbuddies/groupbuddies';
...
export class Groupchat {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public groupservice: Groupsprovider,
    public actionSheet: ActionSheetController, public events: Events, public imgstore: Imghandler, public loadingCtrl: LoadingController) {
      ...
      buttons: [
        {
          ...
          icon: 'person-add',
          handler: () => {
            this.navCtrl.push(Groupbuddies);
          }
        },
        {
          text: 'Remove member',
          icon: 'remove-circle',
          handler: () => {
            this.navCtrl.push(Groupmembers);
          }
        },
        {
          text: 'Group Info',
          icon: 'person',
          handler: () => {
            this.navCtrl.push(Groupinfo, {groupName: this.groupName});
          }
        },
        {
          text: 'Delete Group',
